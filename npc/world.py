...
def default_world() -> Dict:
    ...
    return {
        ...
        "_resource_regen": 1,
        # 资源别名(2026-09-18): 接单/检索用的同义词。**参考世界必须声明**
        # —— 不声明则加载世界后词典每条只剩规范名自身, "砍柴/木头" 这类同义说法
        # 全部接不住(而测试都跑在"未加载世界"态, 走硬编码默认表, 恒绿看不见)。
        "_resource_aliases": {
            "木材": ["木材", "木头", "柴", "木", "树"],
            "浆果": ["浆果", "果"],
            "石头": ["石头", "石"],
        ...
        "craft_at": "村庄",
        "_default_spawn": "村庄",
        # Q4 阶段一(2026-09-17): 自治档位 —— 参考世界也**尊重"无人在场就不推进"**，
        # 免得跑起服务却没人用时空烧 LLM token（"1 真小时 = 20 游戏小时"，见《大脑架构》§30.5）。
